...
{
    public class CurrentService : IWeatherService<CurrentWeatherDTO, CurrentQueryDTO>
    {
        ...
        public async Task<IEnumerable<CurrentWeatherDTO>> Get(CurrentQueryDTO queryDTO)
        {
